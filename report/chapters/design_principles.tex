...
\begin{figure}[h] \centering \includegraphics[width=0.8\textwidth]{overview_map.png} \caption{Initial overview of all bird observations in Sweden.} \label{fig:overview} \end{figure}
...
\begin{figure}[h] \centering \includegraphics[width=0.4\textwidth]{species_dropdown.png} \caption{Species selection dropdown for filtering observations.} \label{fig:dropdown} \end{figure}
...
\begin{figure}[h] \centering \includegraphics[width=0.4\textwidth]{species_details.png} \caption{Detailed information displayed upon species selection.} \label{fig:details_on_demand} \end{figure}
